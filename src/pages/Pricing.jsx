...
const Pricing = () => {
  return (
    <div style={{backgroundColor:"green", color:"white", textAlign:"center"}}>
      Prcing go and come back 1 week ago - A paragraph (from Ancient Greek παράγραφος (parágraphos) 'to write beside') is a self-contained unit of discourse in writing dealing with a particular point or idea. Though not required by the orthographic conventions of any language with a writing system,
...
<br/>
To start using the footer component you need to import it from
 Prcing go and come back 1 week ago - A paragraph (from Ancient Greek παράγραφος (parágraphos) 'to write beside') is a self-contained unit of discourse in writing dealing with a particular point or idea. Though not required by the orthographic conventions of any language with a writing system,
      Use the footer component at the end of your page to show content such as sitemap links, brand logo, social icons and more using React and Tailwind CSS
